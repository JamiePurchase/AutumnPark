...
public class JvPotionShop
{

	public JvPotionShop()
	{
		// Data
		Game.world.setName("JvPotionShop");
		Game.world.setLocation("Trusted Tonics - Jharva Village");
		...
		Game.world.setTile(24, 10, Assets.tlsJharvaInterior[10], 1);
		Game.world.setTile(25, 10, Assets.tlsJharvaInterior[10], 1);
		...
		// Portals
		Game.world.setPortal("Collide", 21, 19, "JvExterior", 52, 55, "S", 31, 44);
		Game.world.setPortal("Collide", 22, 19, "JvExterior", 52, 55, "S", 31, 44);
		
		// NPCs (temp)
		int id = Game.world.setNpc(new BoardNpc(22, 12, "S"));
		Game.world.npcObject[id].setImageIdleAuto(Assets.npcMerchantF1);
